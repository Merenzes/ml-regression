...
#DATABASE COMPONENTS MEANING)
#gmat- Graduate Management Admission Test (result of a test)
#gpa-Grade Point Average (average of grades)
#work experience (in years)
#admission to the university (1-YES, 0-NO)

#database components are copied directly to the script 
...
#applying pandas Dataframe 
data = pandas.DataFrame(candidates,columns= ['gmat', 'gpa','workExperience','admission'])

#setting the independend and dependend variables 
X = data[['gmat', 'gpa','workExperience']] #independent
y = data['admission']  #dependent
